...
!(function(a, b) {
	...
	var t = (function(a) {
			...
			if (!e && ((b ? b.ownerDocument || b : v) !== n && m(b), (b = b || n), p)) {
				...
				if (c.qsa && !A[a + ' '] && (!q || !q.test(a))) {
					if (1 !== x) (w = b), (s = a);
						...
						(k = b.getAttribute('id'))
							? (k = k.replace(aa, '\\$&'))
							: b.setAttribute('id', (k = u)), (r = g(a)), (h = r.length), (l = V.test(k)
							? '#' + k
							: "[id='" + k + "']");
		...
		(pa.prototype = d.filters = d.pseudos), (d.setFilters = new pa()), (g = fa.tokenize = function(a, b) {
			...
			while (h) {
				(c && !(e = R.exec(h))) ||
					(e && (h = h.slice(e[0].length) || h), i.push((f = []))), (c = !1), (e = S.exec(h)) &&
		...
		return (h = fa.compile = function(a, b) {
			...
			u.split('').sort(B).join('') === u), (c.detectDuplicates = !!l), m(), (c.sortDetached = ia(function(a) {
		...
		if (M(a)) {
			...
			if ((k && j[k] && (e || j[k].data)) || void 0 !== d || 'string' != typeof b)
				return k || (k = i ? (a[h] = c.pop() || n.guid++) : h), j[k] ||
					(j[k] = i ? {} : { toJSON: n.noop }), ('object' != typeof b && 'function' != typeof b) ||
					(e ? (j[k] = n.extend(j[k], b)) : (j[k].data = n.extend(j[k].data, b))), (g = j[k]), e ||
					(g.data || (g.data = {}), (g = g.data)), void 0 !== d && (g[n.camelCase(b)] = d), 'string' ==
				typeof b
			...
			if (g[h]) {
				if (b && (d = c ? g[h] : g[h].data)) {
					n.isArray(b)
						...
						: b in d ? (b = [b]) : ((b = n.camelCase(b)), (b = b in d ? [b] : b.split(' '))), (e =
						b.length);
		...
		add: function(a, b, c, d, e) {
			...
			if (r) {
				c.handler && ((i = c), (c = i.handler), (e = i.selector)), c.guid || (c.guid = n.guid++), (g =
					r.events) || (g = r.events = {}), (k = r.handle) ||
					(
			...
			function k() {
				...
				m.appendChild(i), (j.style.cssText =
					...
					(
						...
						j.removeChild(k)
					), (j.style.display = 'none'), (f = 0 === j.getClientRects().length), f &&
					(
						(j.style.display = ''),
	...
	n.extend({
		...
		css: function(a, b, c, d) {
			...
			return (b = n.cssProps[h] || (n.cssProps[h] = bb(h) || h)), (g = n.cssHooks[b] || n.cssHooks[h]), g &&
				'get' in g &&
				(f = g.get(a, !0, c)), void 0 === f && (f = Sa(a, b, d)), 'normal' === f &&
				b in $a &&
	...
	n.fn.extend({
		...
		(yb && xb) || !wb.test(b)
			? (vb[b] = function(a, b, d) {
					var e, f;
					return d ||
						((f = vb[b]), (vb[b] = e), (e = null != c(a, b, d) ? b.toLowerCase() : null), (vb[b] = f)), e;
				})
			: (vb[b] = function(a, b, c) {
	...
	n.extend({
		...
		ajax: function(b, c) {
			...
			(i = n.event && l.global), i &&
				0 === n.active++ &&
				n.event.trigger('ajaxStart'), (l.type = l.type.toUpperCase()), (l.hasContent = !Lb.test(l.type)), (f =
				l.url), l.hasContent ||
				(
	...
	(n.offset = {
		setOffset: function(a, b, c) {
			...
			'static' === k && (a.style.position = 'relative'), (h = l.offset()), (f = n.css(a, 'top')), (i = n.css(
				a,
				'left'
			)), (j = ('absolute' === k || 'fixed' === k) && n.inArray('auto', [f, i]) > -1), j
